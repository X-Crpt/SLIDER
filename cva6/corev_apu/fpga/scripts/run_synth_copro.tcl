...
# (top = spx_unit_xif_synth_top). No CVA6 core, no SoC, no IPs.
#
# Required env vars:
...
#                     (default: spx_unit_xif_synth_top)
...
if {[info exists ::env(COPRO_TOP)]} {
  ...
  set top "spx_unit_xif_synth_top"
}
...
set_property include_dirs [list \
    ...
    "${repo_dir}/../rtl/spx-unit/hw/include" \
] [current_fileset]
...
set rtl_files [list \
    "${repo_dir}/../rtl/spx-unit/hw/include/spx_unit_pkg.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/keccak/pkg_keccak.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/keccak/keccak_round_constants_gen.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/keccak/keccak_round.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/keccak/keccak_dp.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/keccak/keccak_cu.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/keccak/keccak_f.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/spx_unit_register.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/chain_lengths.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/sphincs_ops.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/spx_unit.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/spx_unit_xif_id.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/spx_unit_xif_ex.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/spx_unit_xif_cid.sv" \
    "${repo_dir}/../rtl/spx-unit/hw/spx_unit_xif.sv" \
    "${repo_dir}/../rtl/spx-unit/synth/spx_unit_xif_synth_top.sv" \
]

# Header registered as global include (needed by spx_unit_xif_synth_top)
