...
package spx_unit_pkg;
  ...
  // --------------------------------------------------------------------------
  localparam logic [6:0]  SPX_UNIT_OPCODE = 7'b1011011;     // RISC-V CUSTOM-2
  localparam logic [31:0] SPX_UNIT_MASK   = 32'hFE00_707F;
  ...
  parameter copro_issue_resp_t CoproInstr[NbInstr] = '{
    ...
    '{ instr: {7'h00, 5'b0, 5'b0, 3'b000, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b000},
       opcode: OP_INIT },
    '{ instr: {7'h01, 5'b0, 5'b0, 3'b000, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b000},
       opcode: OP_KSTART },
    '{ instr: {7'h02, 5'b0, 5'b0, 3'b000, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b000},
       opcode: OP_KPERM },

    // ---- Group 1: data IN (rs1=data64, rs2=lane index), no writeback ----
    '{ instr: {7'h00, 5'b0, 5'b0, 3'b001, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b011},
       opcode: OP_LOAD },
    '{ instr: {7'h01, 5'b0, 5'b0, 3'b001, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b011},
       opcode: OP_KABSORB },

    // ---- Group 2: data OUT (rs1=index/byte_offset), writeback to rd ----
    '{ instr: {7'h00, 5'b0, 5'b0, 3'b010, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b1, register_read:3'b001},
       opcode: OP_STORE },
    '{ instr: {7'h01, 5'b0, 5'b0, 3'b010, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b1, register_read:3'b001},
       opcode: OP_KREAD3 },

    // ---- Group 3: SPHINCS+ thash / prf ; rs2 carries simple_mode flag ----
    '{ instr: {7'h00, 5'b0, 5'b0, 3'b011, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b010},
       opcode: OP_THASH1 },
    '{ instr: {7'h01, 5'b0, 5'b0, 3'b011, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b010},
       opcode: OP_THASH2 },
    '{ instr: {7'h02, 5'b0, 5'b0, 3'b011, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b000},
       opcode: OP_PRF_ADDR },
    '{ instr: {7'h03, 5'b0, 5'b0, 3'b011, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b010},
       opcode: OP_THASH1_192 },
    '{ instr: {7'h04, 5'b0, 5'b0, 3'b011, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b010},
       opcode: OP_THASH2_192 },
    '{ instr: {7'h05, 5'b0, 5'b0, 3'b011, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b010},
       opcode: OP_THASH1_256 },
    '{ instr: {7'h06, 5'b0, 5'b0, 3'b011, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b010},
       opcode: OP_THASH2_256 },
    '{ instr: {7'h07, 5'b0, 5'b0, 3'b011, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b000},
       opcode: OP_PRF_192 },
    '{ instr: {7'h08, 5'b0, 5'b0, 3'b011, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b000},
       opcode: OP_PRF_256 },

    // ---- Group 4: WOTS+ chain lengths (no operands, no writeback) ----
    '{ instr: {7'h00, 5'b0, 5'b0, 3'b100, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b000},
       opcode: OP_CL_128F },
    '{ instr: {7'h01, 5'b0, 5'b0, 3'b100, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b000},
       opcode: OP_CL_192F },
    '{ instr: {7'h02, 5'b0, 5'b0, 3'b100, 5'b0, SPX_UNIT_OPCODE},
       mask : SPX_UNIT_MASK,
       resp : '{accept:1'b1, writeback:1'b0, register_read:3'b000},
       opcode: OP_CL_256F },
    ...
    '{ instr: {5'h00, 2'h0, 5'b0, 5'b0, 3'b101, 5'b0, SPX_UNIT_OPCODE},
       mask : 32'h0000_707F,
