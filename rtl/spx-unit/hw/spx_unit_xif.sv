...
#(
  ...
  spx_unit_xif_id #(
    .copro_issue_resp_t (spx_unit_pkg::copro_issue_resp_t),
    .opcode_t           (spx_unit_pkg::opcode_t),
    .NbInstr            (spx_unit_pkg::NbInstr),
    .CoproInstr         (spx_unit_pkg::CoproInstr),
  ...
  spx_unit_xif_cid #(
    .copro_compressed_resp_t (spx_unit_pkg::copro_compressed_resp_t),
    .NbInstr                 (spx_unit_pkg::NbCompInstr),
    .CoproInstr              (spx_unit_pkg::CoproCompInstr),
