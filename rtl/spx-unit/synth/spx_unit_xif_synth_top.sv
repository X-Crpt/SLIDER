...
// HASH_IP coprocessor (`spx_unit_xif`).
//
// `spx_unit_xif` is fully parametric on the CV-X-IF struct types: synthesizing
...
// full SoC.
//
// Top of this module is the same as `spx_unit_xif` itself, just with concrete
// struct ports instead of generic parameters.

`include "cvxif_types.svh"

module spx_unit_xif_synth_top #(
