...
usage() {
  cat <<'EOF'
Usage:
  sw/pqc-complete/generate_bin_cw305.sh [options] [FOLDER_NAME]
...
Options:
  ...
  -o, --out <path>                        Output root (default: sw/pqc-complete/generated_bin_cw305)
...
OUT_ROOT="$SCRIPT_DIR/generated_bin_cw305"
