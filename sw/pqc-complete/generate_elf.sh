...
usage() {
  cat <<'EOF'
Usage:
  sw/pqc-complete/generate_elf.sh [options] [FOLDER_NAME]
...
Options:
  ...
  -o, --out <path>                        Output root (default: sw/pqc-complete/generated_elf)
      --clean                              Remove all .elf files under output root and exit
  -h, --help                              Show this help

Examples:
  sw/pqc-complete/generate_elf.sh
  sw/pqc-complete/generate_elf.sh --variant optimized
  sw/pqc-complete/generate_elf.sh --name SPHINCS-128f-robust
  sw/pqc-complete/generate_elf.sh SPHINCS-256f-simple
  sw/pqc-complete/generate_elf.sh --test keygen
  sw/pqc-complete/generate_elf.sh --variant original --test-sign-open
  sw/pqc-complete/generate_elf.sh --clean
EOF
}
...
FOLDER_NAME="all"
TEST_MODE="auto"
OUT_ROOT="$SCRIPT_DIR/generated_elf"
CLEAN_ONLY=0
