...
usage() {
  cat <<'EOF'
Usage:
  sw/pqc-complete/generate_elf_cw305.sh [options] [FOLDER_NAME]
...
Options:
  ...
  -o, --out <path>                        Output root (default: sw/pqc-complete/generated_elf_cw305)
...
FOLDER_NAME="all"
TEST_MODE="auto"
OUT_ROOT="$SCRIPT_DIR/generated_elf_cw305"
CLEAN_ONLY=0
...
if [[ $found_any -eq 0 ]]; then
  echo "No PQC run.sh scripts found under sw/pqc-complete." >&2; exit 1
fi
