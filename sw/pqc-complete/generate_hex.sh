...
usage() {
  cat <<'EOF'
Usage:
  sw/pqc-complete/generate_hex.sh [options] [FOLDER_NAME]
...
Options:
  ...
  -o, --out <path>                        Output root (default: sw/pqc-complete/generated_hex)
      --clean                              Remove all .hex files under output root and exit
  -h, --help                              Show this help

Examples:
  sw/pqc-complete/generate_hex.sh
  sw/pqc-complete/generate_hex.sh --variant optimized
  sw/pqc-complete/generate_hex.sh --name SPHINCS-128f-robust
  sw/pqc-complete/generate_hex.sh SPHINCS-256f-simple
  sw/pqc-complete/generate_hex.sh --test keygen
  sw/pqc-complete/generate_hex.sh --variant original --test-sign-open
  sw/pqc-complete/generate_hex.sh --clean
EOF
}
...
FOLDER_NAME="all"
TEST_MODE="auto"
OUT_ROOT="$SCRIPT_DIR/generated_hex"
CLEAN_ONLY=0
