#!/bin/bash
# =============================================================================
# Per-test runner for SLH-DSA original tests.
# =============================================================================
: "${LD_LIBRARY_PATH:=}"; export LD_LIBRARY_PATH

THIS_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
TEST_NAME="SLH-DSA-original-SPHINCS-192f-simple"
...
TEST_DIR=../../../sw/pqc-complete/original/DS/SLH-DSA/SPHINCS-192f-simple
