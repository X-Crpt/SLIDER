#!/bin/bash
# =============================================================================
# sw/pqc-complete/run_spx.sh - Interactive picker for SLH-DSA SPHINCS+ variants
#
# This script lets users choose between original (pure-C reference) and
# optimized (spx-unit-accelerated) versions of SPHINCS+ (128f, 192f, 256f)
# in both robust and simple modes.
#
# Usage (from anywhere, either way works):
#     bash   sw/pqc-complete/run_spx.sh        # spawns a child shell
#     source sw/pqc-complete/run_spx.sh        # runs in the current shell
#
...
# Collect all SLH-DSA run.sh scripts (both original and optimized)
...
for i in "${!SCRIPTS[@]}"; do
    ...
    # Determine if original (reference) or optimized
