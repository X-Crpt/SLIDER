...
src_main=../../../sw/simple/chain-lengths/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../../sw/simple/chain-lengths/original/chain_lengths_sw.c
)
...
cflags=(
    ...
    -I../../../sw/simple/chain-lengths
    -I../../../sw/simple/chain-lengths/original
    -I../../../sw/simple/chain-lengths/optimized
    -I../../../sw/inc
    -I../../../sw/simple
)
