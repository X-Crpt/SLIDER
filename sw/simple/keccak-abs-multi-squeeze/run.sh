...
src_main=../../../sw/simple/keccak-abs-multi-squeeze/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../../sw/simple/keccak-abs-multi-squeeze/original/fips202.c
    ../../../sw/simple/keccak-abs-multi-squeeze/optimized/fips202_hw.c
    ../../../sw/simple/keccak-abs-multi-squeeze/spx_unit_coproc.S
)
...
cflags=(
    ...
    -I../../../sw/simple/keccak-abs-multi-squeeze
    -I../../../sw/simple/keccak-abs-multi-squeeze/original
    -I../../../sw/simple/keccak-abs-multi-squeeze/optimized
    -I../../../sw/inc
    -I../../../sw/simple
)
