...
src_main=../../../sw/simple/keccak-abs-sha3-256-multi-block/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../../sw/simple/keccak-abs-sha3-256-multi-block/original/fips202.c
    ../../../sw/simple/keccak-abs-sha3-256-multi-block/optimized/fips202_hw.c
    ../../../sw/simple/keccak-abs-sha3-256-multi-block/spx_unit_coproc.S
)
...
cflags=(
    ...
    -I../../../sw/simple/keccak-abs-sha3-256-multi-block
    -I../../../sw/simple/keccak-abs-sha3-256-multi-block/original
    -I../../../sw/simple/keccak-abs-sha3-256-multi-block/optimized
    -I../../../sw/inc
    -I../../../sw/simple
)
