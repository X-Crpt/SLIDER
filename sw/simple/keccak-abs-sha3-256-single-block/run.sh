...
src_main=../../../sw/simple/keccak-abs-sha3-256-single-block/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../../sw/simple/keccak-abs-sha3-256-single-block/original/fips202.c
    ../../../sw/simple/keccak-abs-sha3-256-single-block/optimized/fips202_hw.c
    ../../../sw/simple/keccak-abs-sha3-256-single-block/spx_unit_coproc.S
)
...
cflags=(
    ...
    -I../../../sw/simple/keccak-abs-sha3-256-single-block
    -I../../../sw/simple/keccak-abs-sha3-256-single-block/original
    -I../../../sw/simple/keccak-abs-sha3-256-single-block/optimized
    -I../../../sw/inc
    -I../../../sw/simple
)
