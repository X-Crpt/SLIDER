...
src_main=../../../sw/simple/prf-addr/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../../sw/simple/prf-addr/spx_unit_coproc.S
    ../../../sw/simple/prf-addr/optimized/prf_hw.c
    ../../../sw/simple/prf-addr/original/prf_sw.c
)
...
cflags=(
    ...
    -I../../../sw/simple/prf-addr
    -I../../../sw/simple/prf-addr/original
    -I../../../sw/simple/prf-addr/optimized
    -I../../../sw/inc
    -I../../../sw/simple
)
