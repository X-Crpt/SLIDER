#!/bin/bash
# =============================================================================
# sw/simple/run_tests.sh - Interactive picker that dispatches to a per-test
# `run.sh`.  Each sw/simple/<test>/run.sh is self-contained and known to work.
#
# Usage (from anywhere, either way works):
#     bash   sw/simple/run_tests.sh        # spawns a child shell
#     source sw/simple/run_tests.sh        # runs in the current shell
#
