...
src_main=../../../sw/simple/thash-wots/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../../sw/simple/thash-wots/spx_unit_coproc.S
    ../../../sw/simple/thash-wots/optimized/thash_hw.c
    ../../../sw/simple/thash-wots/original/thash_sw.c
    ../../../sw/simple/thash-wots/optimized/wots_chain_hw.c
    ../../../sw/simple/thash-wots/original/wots_chain_sw.c
)
...
cflags=(
    ...
    -I../../../sw/simple/thash-wots
    -I../../../sw/simple/thash-wots/original
    -I../../../sw/simple/thash-wots/optimized
    -I../../../sw/inc
    -I../../../sw/simple
)
