...
src_main=../../../sw/simple/thash/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../../sw/simple/thash/spx_unit_coproc.S
    ../../../sw/simple/thash/optimized/thash_hw.c
    ../../../sw/simple/thash/original/thash_sw.c
)
...
cflags=(
    ...
    -I../../../sw/simple/thash
    -I../../../sw/simple/thash/original
    -I../../../sw/simple/thash/optimized
    -I../../../sw/inc
    -I../../../sw/simple
)
