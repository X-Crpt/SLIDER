...
src_main=../../../sw/simple/thash2/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../../sw/simple/thash2/spx_unit_coproc.S
    ../../../sw/simple/thash2/optimized/thash_hw.c
    ../../../sw/simple/thash2/original/thash_sw.c
)
...
cflags=(
    ...
    -I../../../sw/simple/thash2
    -I../../../sw/simple/thash2/original
    -I../../../sw/simple/thash2/optimized
    -I../../../sw/inc
    -I../../../sw/simple
)
